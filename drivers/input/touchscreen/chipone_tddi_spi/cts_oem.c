...
#define OEM_OF_DEF_PROPVAL_RAWDATA_MIN      648
#define OEM_OF_DEF_PROPVAL_RAWDATA_MAX      1876
#define OEM_OF_DEF_PROPVAL_NOISE_FRAMES     16
#define OEM_OF_DEF_PROPVAL_NOISE_MAX        200
#define OEM_OF_DEF_PROPVAL_OPEN_MIN         1800
#define OEM_OF_DEF_PROPVAL_SHORT_MIN        900
#define OEM_OF_DEF_PROPVAL_COMP_CAP_MIN     1
#define OEM_OF_DEF_PROPVAL_COMP_CAP_MAX     127
// +P86801AA1 peiyuexiang.wt,add,20230803,compatible HJR
#define OEM_OF_DEF_PROPVAL_RAWDATA_FRAMES_HJR   1
#define OEM_OF_DEF_PROPVAL_RAWDATA_MIN_HJR      984
#define OEM_OF_DEF_PROPVAL_RAWDATA_MAX_HJR      2744
#define OEM_OF_DEF_PROPVAL_NOISE_FRAMES_HJR     16
#define OEM_OF_DEF_PROPVAL_NOISE_MAX_HJR        150
#define OEM_OF_DEF_PROPVAL_OPEN_MIN_HJR         1800
#define OEM_OF_DEF_PROPVAL_SHORT_MIN_HJR        900
#define OEM_OF_DEF_PROPVAL_COMP_CAP_MIN_HJR     1
#define OEM_OF_DEF_PROPVAL_COMP_CAP_MAX_HJR     127
// -P86801AA1 peiyuexiang.wt,add,20230803,compatible HJR
// +P86801AA1 peiyuexiang.wt,add,20230803,compatible TXD
#define OEM_OF_DEF_PROPVAL_RAWDATA_FRAMES_TXD   1
#define OEM_OF_DEF_PROPVAL_RAWDATA_MIN_TXD      984
#define OEM_OF_DEF_PROPVAL_RAWDATA_MAX_TXD      2744
#define OEM_OF_DEF_PROPVAL_NOISE_FRAMES_TXD     16
#define OEM_OF_DEF_PROPVAL_NOISE_MAX_TXD        150
#define OEM_OF_DEF_PROPVAL_OPEN_MIN_TXD         1800
#define OEM_OF_DEF_PROPVAL_SHORT_MIN_TXD        900
#define OEM_OF_DEF_PROPVAL_COMP_CAP_MIN_TXD     1
#define OEM_OF_DEF_PROPVAL_COMP_CAP_MAX_TXD     127
// -P86801AA1 peiyuexiang.wt,add,20230803,compatible TXD
// +P86801AA1 peiyuexiang.wt,add,20230905,compatible XINXIAN
#define OEM_OF_DEF_PROPVAL_RAWDATA_FRAMES_XINXIAN   1
#define OEM_OF_DEF_PROPVAL_RAWDATA_MIN_XINXIAN      984
#define OEM_OF_DEF_PROPVAL_RAWDATA_MAX_XINXIAN      2744
#define OEM_OF_DEF_PROPVAL_NOISE_FRAMES_XINXIAN     16
#define OEM_OF_DEF_PROPVAL_NOISE_MAX_XINXIAN        150
#define OEM_OF_DEF_PROPVAL_OPEN_MIN_XINXIAN         1800
#define OEM_OF_DEF_PROPVAL_SHORT_MIN_XINXIAN        900
#define OEM_OF_DEF_PROPVAL_COMP_CAP_MIN_XINXIAN     1
#define OEM_OF_DEF_PROPVAL_COMP_CAP_MAX_XINXIAN     127
// -P86801AA1 peiyuexiang.wt,add,20230905,compatible XINXIAN
// +P86801AA1 lihesong.wt,add,20230920,compatible dijin
#define OEM_OF_DEF_PROPVAL_RAWDATA_FRAMES_DIJIN   1
#define OEM_OF_DEF_PROPVAL_RAWDATA_MIN_DIJIN      990
#define OEM_OF_DEF_PROPVAL_RAWDATA_MAX_DIJIN      2730
#define OEM_OF_DEF_PROPVAL_NOISE_FRAMES_DIJIN     16
#define OEM_OF_DEF_PROPVAL_NOISE_MAX_DIJIN        150
#define OEM_OF_DEF_PROPVAL_OPEN_MIN_DIJIN         1800
#define OEM_OF_DEF_PROPVAL_SHORT_MIN_DIJIN        900
...
// +P86801AA1 peiyuexiang.wt,add,20230624,chipone_icnl9951r openshort
#define OEM_SELFTEST_PROC_FILENAME          "ctp_openshort_test"
// -P86801AA1 peiyuexiang.wt,add,20230624,chipone_icnl9951r openshort
    ...
    do { \
        if (oem_data->test_##type) { \
            if (oem_data->type##_test_data == NULL) { \
                ...
                oem_data->type##_test_data = vmalloc(size); \
                if (oem_data->type##_test_data == NULL) { \
...
#define FREE_TEST_DATA_MEM(type) \
    do { \
        if (oem_data->type##_test_data) { \
            ...
            vfree(oem_data->type##_test_data); \
    ...
    struct device_node *np)
{
    ...
    if (oem_data->test_rawdata) {
        ...
        if (strstr(Lcm_name_tp,"hjr_icnl9951r_wt_dsi_vdo_90hz_hkc")){
            oem_data->rawdata_test_frames = OEM_OF_DEF_PROPVAL_RAWDATA_FRAMES_HJR;
        }
        if (strstr(Lcm_name_tp,"txd_icnl9951r_wt_dsi_vdo_90hz_hkc")){
            oem_data->rawdata_test_frames = OEM_OF_DEF_PROPVAL_RAWDATA_FRAMES_TXD;
        }
        if (strstr(Lcm_name_tp,"xinxian_icnl9951r_wt_dsi_vdo_90hz_mdt")){
            oem_data->rawdata_test_frames = OEM_OF_DEF_PROPVAL_RAWDATA_FRAMES_XINXIAN;
        }
        ...
        if (strstr(Lcm_name_tp,"hjr_icnl9951r_wt_dsi_vdo_90hz_hkc")){
            oem_data->rawdata_min = OEM_OF_DEF_PROPVAL_RAWDATA_MIN_HJR;
        }
        if (strstr(Lcm_name_tp,"txd_icnl9951r_wt_dsi_vdo_90hz_hkc")){
            oem_data->rawdata_min = OEM_OF_DEF_PROPVAL_RAWDATA_MIN_TXD;
        }
        if (strstr(Lcm_name_tp,"xinxian_icnl9951r_wt_dsi_vdo_90hz_mdt")){
            oem_data->rawdata_min = OEM_OF_DEF_PROPVAL_RAWDATA_MIN_XINXIAN;
        }
        if (strstr(Lcm_name_tp,"djn_icnl9951r_wt_dsi_vdo_90hz_boe")){
        ...
        if (strstr(Lcm_name_tp,"hjr_icnl9951r_wt_dsi_vdo_90hz_hkc")){
            oem_data->rawdata_max = OEM_OF_DEF_PROPVAL_RAWDATA_MAX_HJR;
        }
        if (strstr(Lcm_name_tp,"txd_icnl9951r_wt_dsi_vdo_90hz_hkc")){
            oem_data->rawdata_max = OEM_OF_DEF_PROPVAL_RAWDATA_MAX_TXD;
        }
        if (strstr(Lcm_name_tp,"xinxian_icnl9951r_wt_dsi_vdo_90hz_mdt")){
            oem_data->rawdata_max = OEM_OF_DEF_PROPVAL_RAWDATA_MAX_XINXIAN;
        }
        if (strstr(Lcm_name_tp,"djn_icnl9951r_wt_dsi_vdo_90hz_boe")){
    ...
    if (oem_data->test_noise) {
        ...
        if (strstr(Lcm_name_tp,"hjr_icnl9951r_wt_dsi_vdo_90hz_hkc")){
            oem_data->noise_test_frames = OEM_OF_DEF_PROPVAL_NOISE_FRAMES_HJR;
        }
        if (strstr(Lcm_name_tp,"txd_icnl9951r_wt_dsi_vdo_90hz_hkc")){
            oem_data->noise_test_frames = OEM_OF_DEF_PROPVAL_NOISE_FRAMES_TXD;
        }
        if (strstr(Lcm_name_tp,"xinxian_icnl9951r_wt_dsi_vdo_90hz_mdt")){
            oem_data->noise_test_frames = OEM_OF_DEF_PROPVAL_NOISE_FRAMES_XINXIAN;
        }
        if (strstr(Lcm_name_tp,"djn_icnl9951r_wt_dsi_vdo_90hz_boe")){
        ...
        if (strstr(Lcm_name_tp,"hjr_icnl9951r_wt_dsi_vdo_90hz_hkc")){
            oem_data->noise_max = OEM_OF_DEF_PROPVAL_NOISE_MAX_HJR;
        }
        if (strstr(Lcm_name_tp,"txd_icnl9951r_wt_dsi_vdo_90hz_hkc")){
            oem_data->noise_max = OEM_OF_DEF_PROPVAL_NOISE_MAX_TXD;
        }
        if (strstr(Lcm_name_tp,"xinxian_icnl9951r_wt_dsi_vdo_90hz_mdt")){
            oem_data->noise_max = OEM_OF_DEF_PROPVAL_NOISE_MAX_XINXIAN;
        }
        if (strstr(Lcm_name_tp,"djn_icnl9951r_wt_dsi_vdo_90hz_boe")){
    ...
    if (oem_data->test_open) {
        ...
        if (strstr(Lcm_name_tp,"hjr_icnl9951r_wt_dsi_vdo_90hz_hkc")){
            oem_data->open_min = OEM_OF_DEF_PROPVAL_OPEN_MIN_HJR;
        }
        if (strstr(Lcm_name_tp,"txd_icnl9951r_wt_dsi_vdo_90hz_hkc")){
            oem_data->open_min = OEM_OF_DEF_PROPVAL_OPEN_MIN_TXD;
        }
        if (strstr(Lcm_name_tp,"xinxian_icnl9951r_wt_dsi_vdo_90hz_mdt")){
            oem_data->open_min = OEM_OF_DEF_PROPVAL_OPEN_MIN_XINXIAN;
        }
        if (strstr(Lcm_name_tp,"djn_icnl9951r_wt_dsi_vdo_90hz_boe")){
    ...
    if (oem_data->test_short) {
        ...
        if (strstr(Lcm_name_tp,"hjr_icnl9951r_wt_dsi_vdo_90hz_hkc")){
            oem_data->short_min = OEM_OF_DEF_PROPVAL_SHORT_MIN_HJR;
        }
        if (strstr(Lcm_name_tp,"txd_icnl9951r_wt_dsi_vdo_90hz_hkc")){
            oem_data->short_min = OEM_OF_DEF_PROPVAL_SHORT_MIN_TXD;
        }
        if (strstr(Lcm_name_tp,"xinxian_icnl9951r_wt_dsi_vdo_90hz_mdt")){
            oem_data->short_min = OEM_OF_DEF_PROPVAL_SHORT_MIN_XINXIAN;
        }
        if (strstr(Lcm_name_tp,"djn_icnl9951r_wt_dsi_vdo_90hz_boe")){
    ...
    if (oem_data->test_comp_cap) {
        ...
        if (strstr(Lcm_name_tp,"hjr_icnl9951r_wt_dsi_vdo_90hz_hkc")){
            oem_data->comp_cap_min = OEM_OF_DEF_PROPVAL_COMP_CAP_MIN_HJR;
        }
        if (strstr(Lcm_name_tp,"txd_icnl9951r_wt_dsi_vdo_90hz_hkc")){
            oem_data->comp_cap_min = OEM_OF_DEF_PROPVAL_COMP_CAP_MIN_TXD;
        }
        if (strstr(Lcm_name_tp,"xinxian_icnl9951r_wt_dsi_vdo_90hz_mdt")){
            oem_data->comp_cap_min = OEM_OF_DEF_PROPVAL_COMP_CAP_MIN_XINXIAN;
        }
        if (strstr(Lcm_name_tp,"djn_icnl9951r_wt_dsi_vdo_90hz_boe")){
        ...
        if (strstr(Lcm_name_tp,"hjr_icnl9951r_wt_dsi_vdo_90hz_hkc")){
            oem_data->comp_cap_max = OEM_OF_DEF_PROPVAL_COMP_CAP_MAX_HJR;
        }
        if (strstr(Lcm_name_tp,"txd_icnl9951r_wt_dsi_vdo_90hz_hkc")){
            oem_data->comp_cap_max = OEM_OF_DEF_PROPVAL_COMP_CAP_MAX_TXD;
        }
        if (strstr(Lcm_name_tp,"xinxian_icnl9951r_wt_dsi_vdo_90hz_mdt")){
            oem_data->comp_cap_max = OEM_OF_DEF_PROPVAL_COMP_CAP_MAX_XINXIAN;
        }
        if (strstr(Lcm_name_tp,"djn_icnl9951r_wt_dsi_vdo_90hz_boe")){
...
static int selftest_seq_show(struct seq_file *m, void *v)
{
    ...
    if (oem_data->test_rawdata) {
        if (oem_data->rawdata_test_result == 0) {
            cts_info("FW Rawdata Test PASS!\n\n");
        } else if (oem_data->rawdata_test_result > 0) {
            cts_info("FW Rawdata Test FAIL!\n\n");
            seq_printf(m, "FW Rawdata Test FAIL!\n");
    ...
    if (oem_data->test_noise) {
        if (oem_data->noise_test_result == 0) {
            cts_info("Noise Test PASS!\n\n");
        } else if (oem_data->noise_test_result > 0) {
            cts_info("Noise Test FAIL!\n\n");
            seq_printf(m, "Noise Test FAIL!\n");
    ...
    if (oem_data->test_open) {
        if (oem_data->open_test_result == 0) {
            cts_info("Open Test PASS!\n\n");
        } else if (oem_data->open_test_result > 0) {
            cts_info("Open Test FAIL!\n\n");
    ...
    if (oem_data->test_short) {
        ...
        if (oem_data->short_test_result == 0) {
            cts_info("Short Test PASS!\n\n");
        } else if (oem_data->short_test_result > 0) {
            cts_info("Short Test FAIL!\n\n");
    ...
    if (oem_data->test_comp_cap) {
        if (oem_data->comp_cap_test_result == 0) {
            cts_info("Compensate-Cap Test PASS!\n\n");
        } else if (oem_data->comp_cap_test_result > 0) {
            cts_info("Compensate-Cap Test FAIL!\n\n");
            seq_printf(m, "Compensate-Cap Test FAIL!\n");
...
static int cts_rawdata_show(struct seq_file *m, void *v)
{
    ...
    cts_tcs_top_get_rawdata(cts_dev, rawdata, hwrows * hwcols * 2);
...
static int cts_diffdata_show(struct seq_file *m, void *v)
{
    ...
    cts_lock_device(cts_dev);
    cts_tcs_top_get_real_diff(cts_dev, rawdata, hwrows * hwcols * 2);
    cts_unlock_device(cts_dev);
...
static int cts_manual_show(struct seq_file *m, void *v)
{
    ...
    cts_lock_device(cts_dev);
    cts_tcs_top_get_manual_diff(cts_dev, rawdata, hwrows * hwcols * 2);
    cts_unlock_device(cts_dev);
...
static int cts_cnegdata_show(struct seq_file *m, void *v)
{
    ...
    cts_lock_device(cts_dev);
    cts_tcs_top_get_cnegdata(cts_dev, rawdata, hwrows * hwcols);
    cts_unlock_device(cts_dev);
...
// +P86801AA1 peiyuexiang.wt,add,20230624,chipone_icnl9951r openshort
    if( ctp_device_proc == NULL)
    {
        ...
        if(ctp_device_proc == NULL)
        {
            cts_err("create parent_proc fail\n");
            ret = -EFAULT;
            goto free_oem_data;
        }
    }
    oem_data->selftest_proc_entry =
        proc_create_data(OEM_SELFTEST_PROC_FILENAME,
            S_IRUGO, ctp_device_proc, &selftest_proc_fops, cts_data);
// -P86801AA1 peiyuexiang.wt,add,20230624,chipone_icnl9951r openshort
