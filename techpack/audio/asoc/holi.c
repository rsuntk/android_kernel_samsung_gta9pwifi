...
#endif
//+P86801AA1, zhangtao10.wt, ADD, 2022/05/12, get smartpa info for compatibility
#include <sound/soc.h>
...
#define WCD_MBHC_HS_V_MAX           1700  //P230829-01324, zhangtao10.wt,modify,2023/08/30,HS_VREF 1.7V
...
/*+P86801AA1, daisiqing.wt, ADD, 2023/05/12, add car AUX*/
...
static struct dev_config tdm_rx_cfg[TDM_INTERFACE_MAX][TDM_PORT_MAX] = {
	...
	{ /* SEC TDM */
		{SAMPLING_RATE_48KHZ, SNDRV_PCM_FORMAT_S32_LE, 4}, /* RX_0 */	//P86801AA1, zhangtao10.wt, modify, 2023/04/25, smartpa rx
		{SAMPLING_RATE_48KHZ, SNDRV_PCM_FORMAT_S16_LE, 1}, /* RX_1 */
		{SAMPLING_RATE_48KHZ, SNDRV_PCM_FORMAT_S16_LE, 1}, /* RX_2 */
		{SAMPLING_RATE_48KHZ, SNDRV_PCM_FORMAT_S16_LE, 1}, /* RX_3 */
		{SAMPLING_RATE_48KHZ, SNDRV_PCM_FORMAT_S16_LE, 1}, /* RX_4 */
...
static struct dev_config tdm_tx_cfg[TDM_INTERFACE_MAX][TDM_PORT_MAX] = {
	...
	{ /* SEC TDM */
		{SAMPLING_RATE_48KHZ, SNDRV_PCM_FORMAT_S32_LE, 4}, /* TX_0 */	//P86801AA1, zhangtao10.wt, modify, 2023/04/25, smartpa tx
		{SAMPLING_RATE_48KHZ, SNDRV_PCM_FORMAT_S16_LE, 1}, /* TX_1 */
		{SAMPLING_RATE_48KHZ, SNDRV_PCM_FORMAT_S16_LE, 1}, /* TX_2 */
		{SAMPLING_RATE_48KHZ, SNDRV_PCM_FORMAT_S16_LE, 1}, /* TX_3 */
		{SAMPLING_RATE_48KHZ, SNDRV_PCM_FORMAT_S16_LE, 1}, /* TX_4 */
...
static struct tdm_dev_config sec_tdm_dev_config[MAX_PATH][TDM_PORT_MAX] = {
	{ /* SEC TDM */
		{ {0, 4, 8, 12, 0xFFFF} }, /* RX_0 */	//P86801AA1, zhangtao10.wt, modify, 2023/04/25, smartpa rx
		{ {8,  12, 0xFFFF} }, /* RX_1 */
		{ {16, 20, 0xFFFF} }, /* RX_2 */
		{ {24, 28, 0xFFFF} }, /* RX_3 */
		{ {0xFFFF} }, /* RX_4 */
	...
	{
		{ {0, 4, 8, 12, 0xFFFF} }, /* TX_0 */	//P86801AA1, zhangtao10.wt, modify, 2023/04/25, smartpa tx
		{ {8,  12, 0xFFFF} }, /* TX_1 */
		{ {16, 20, 0xFFFF} }, /* TX_2 */
		{ {24, 28, 0xFFFF} }, /* TX_3 */
		{ {0xFFFF} }, /* TX_4 */
				     ...
				     struct snd_pcm_hw_params *params)
{
	...
	int channels, slots = 4; //TDM_MAX_SLOTS; //P86801AA1, zhangtao10.wt, modify, 2023/04/25, smartpa slot num
...
#ifdef CONFIG_SND_SOC_FS19XX_TDM
	if (smartpa_type == FS16XX) {
		if (fsm_get_dev_count() > 0 && !strcmp(rtd->codec_dai->name,
					fsm_codec_dai_name(0))) {
			ret = snd_soc_dai_set_sysclk(rtd->codec_dai,
					0, clk_freq, SND_SOC_CLOCK_IN);
			if (ret < 0)
				pr_err("%s: failed to set codec sysclk, err:%d\n",
						__func__, ret);
		}
	}
#endif
...
//+P86801AA1, zhangtao10.wt, ADD, 2023/04/25, smartpa iv tx
	{/* hw:x,33 */
		.name = "Secondary TDM0 TX_Hostless",
...
#if defined(CONFIG_SND_SMARTPA_AW882XX) && defined(CONFIG_SND_SOC_FS19XX)
static struct snd_soc_dai_link msm_awinic_be_dai_links[] = {
	{
		...
		.ignore_suspend = 1,
		.ignore_pmdown_time = 1,
		SND_SOC_DAILINK_REG(sec_tdm_rx_0_aw),
	},
};

static struct snd_soc_dai_link msm_foursemi_be_dai_links[] = {
	{
		.name = LPASS_BE_SEC_TDM_RX_0,
		.stream_name = "Secondary TDM0 Playback",
		.no_pcm = 1,
		...
		.ignore_suspend = 1,
		.ignore_pmdown_time = 1,
		SND_SOC_DAILINK_REG(sec_tdm_rx_0_fsm),
	},
};
#endif
//-P86801AA1, zhangtao10.wt, ADD, 2023/05/13, smartpa compatibility
...
//+P86801AA1, zhangtao10.wt, ADD, 2023/05/13, smartpa compatibility
			...
			ARRAY_SIZE(msm_foursemi_be_dai_links) +
#endif
//-P86801AA1, zhangtao10.wt, ADD, 2023/05/13, smartpa compatibility
...
//+P86801AA1, zhangtao10.wt, ADD, 2023/05/13, smartpa compatibility
		...
		if(smartpa_type == FS16XX) {
			memcpy(msm_holi_dai_links + total_links,
			       msm_foursemi_be_dai_links,
			       sizeof(msm_foursemi_be_dai_links));
			total_links += ARRAY_SIZE(msm_foursemi_be_dai_links);
		} else if((smartpa_type == AW88266) || (smartpa_type == AW88257)) {
			memcpy(msm_holi_dai_links + total_links,
			       msm_awinic_be_dai_links,
			       sizeof(msm_awinic_be_dai_links));
			total_links += ARRAY_SIZE(msm_awinic_be_dai_links);
		}
#endif
//-P86801AA1, zhangtao10.wt, ADD, 2023/05/13, smartpa compatibility
