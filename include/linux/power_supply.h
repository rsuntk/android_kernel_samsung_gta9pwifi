...
enum power_supply_type {
	...
	#ifdef CONFIG_QGKI_BUILD
	POWER_SUPPLY_TYPE_USB_AFC,		/* AFC charger */
	POWER_SUPPLY_TYPE_USB_PE,       /*PE charger*/
	POWER_SUPPLY_TYPE_USB_NONSTAND_1A,
	POWER_SUPPLY_TYPE_USB_NONSTAND_1P5A,
	POWER_SUPPLY_TYPE_USB_NONSTAND_2A,
	#endif
};
